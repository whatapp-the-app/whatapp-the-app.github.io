...
function LandingPage(props){
    ...
    return(
        ...
        {start ? <><Grid item xs={12}>
          <div className={classes.paper}>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vitae nunc quis arcu eleifend posuere. Vivamus bibendum lacus et nisi posuere tincidunt. Vestibulum interdum et lacus quis cursus. Sed sed risus rhoncus, lobortis massa eget, cursus metus. Quisque varius, justo in tristique vulputate, massa ex bibendum mauris, et ornare sapien sapien ut nulla.</p>
          </div>
        </Grid>
        ...
        <Grid item xs={12}>
          <div className={classes.paper}>
            ...
            <Button variant="contained" color="primary" onClick={()=>{setStart(false)}}>
              Let's go!
            </Button>
          </div>
        </Grid></>:
